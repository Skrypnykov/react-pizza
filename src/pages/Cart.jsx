...
function Cart() {
  ...
  const { totalCount, totalCost, items } = useSelector(({ cart }) => cart);
  ...
  const onClickOrder = () => {
    console.log('ВАШ ЗАКАЗ', items, 'Сумма заказа: ' + totalCost + ' грн.');
    dispatch(clearCart());
  };
        ...
        <div className="cart">
...

            {
              addedPizzas.map((obj) => (
                <CartItem
                  ...
                  totalCost={items[obj.id].totalCost}
          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
              ...
              <span> Сумма заказа: <b>{totalCost} ₴</b> </span>
            </div>
